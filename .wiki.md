...
- **Mobile Counting Screen**: Manage and filter counting data by sectors, now supporting fractional quantities for various units.
...
- **CountingMobile.tsx**: Manages mobile counting interface with support for fractional quantities for various units, including a calculator for converting quantities.
