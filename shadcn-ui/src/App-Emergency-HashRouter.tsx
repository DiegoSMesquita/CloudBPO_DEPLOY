...
// Emergency HashRouter version - works without server configuration
// URLs will be: https://cloudbpov1.mgx.world/#/mobile/counting/id
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* EMERGENCY: Mobile counting routes - HashRouter format */}
